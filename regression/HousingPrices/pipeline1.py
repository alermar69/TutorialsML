...
from sklearn.preprocessing import OneHotEncoder, StandardScaler, FunctionTransformer, RobustScaler, KBinsDiscretizer
...
class BasicTransformer(BaseEstimator):
    ...
    def fit(self, X, y=None):
        ...
        if self.asymmetry:
            ...
            self._feature_names = np.append(self._feature_names, self._bins_names)
...
ct = ColumnTransformer([('bt', pipe, trn.columns.values)], remainder='passthrough')

x1 = ct.fit_transform(train)
